...
// Public routes (no auth) — PostForMe browser redirect
const socialAccountPublicRouter = Router()
socialAccountPublicRouter.get('/callback', socialAccountController.handleOAuthRedirect)
...
export { socialAccountRouter, socialAccountPublicRouter }
